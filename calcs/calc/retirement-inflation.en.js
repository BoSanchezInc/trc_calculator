...
PMSFLWrite("\n");
PMSFLWrite("</style>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-retirement-inflation\" class=\"pmsfl-calculator\">\n");
PMSFLWrite("<div class=\"calc-outer\">\n");
PMSFLWrite("<div class=\"calc-inner\">\n");
PMSFLWrite("<h1>Inflation Impact On Retirement</h1>\n");
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("Planning for life after retirement and want to make sure your\n");
PMSFLWrite("nest egg is going to be enough?  Use this calculator to\n");
PMSFLWrite("understand how inflation will affect the income level you need\n");
PMSFLWrite("when you retire.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<form>\n");
...
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-col-1of4\">Enter your current age:</td>\n");
PMSFLWrite("<td class=\"calc-col-2of4\">&#160;</td>\n");
PMSFLWrite("<td class=\"calc-col-3of4\"><input name=\"c_age\" type=\"text\" size=\"10\"/></td>\n");
PMSFLWrite("<td class=\"calc-col-4of4\">&#160;</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>Enter the age you plan to retire:</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("<td><input name=\"r_age\" type=\"text\" size=\"10\"/></td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>Enter the age you expect to live to:</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("<td><input name=\"l_age\" type=\"text\" size=\"10\"/></td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>\n");
PMSFLWrite("What do you anticipate your monthly monetary needs\n");
PMSFLWrite("will be when you retire, based on today\'s costs?\n");
PMSFLWrite("<a href=\"#\" class=\"calc-help-button\">&#160;&#160;&#160;&#160;&#160;</a>\n");
PMSFLWrite("\n");
PMSFLWrite("<span class=\"calc-help-details\" style=\"display:none\">\n");
PMSFLWrite("<br/>(Consider that you may no longer have a\n");
PMSFLWrite("mortgage or that health care costs may increase,\n");
PMSFLWrite("etc.)\n");
PMSFLWrite("</span>\n");
PMSFLWrite("</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input name=\"needs\" type=\"text\" size=\"10\"/></td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>\n");
PMSFLWrite("Anticipated Inflation Rate\n");
PMSFLWrite("<a href=\"#\" class=\"calc-help-button\">&#160;&#160;&#160;&#160;&#160;</a>\n");
PMSFLWrite("\n");
PMSFLWrite("<span class=\"calc-help-details\" style=\"display:none\">\n");
PMSFLWrite("<br/>(Enter the inflation rate to be used for these\n");
PMSFLWrite("calculations.  Typically, the historical average is\n");
PMSFLWrite("2-3% per year)\n");
PMSFLWrite("</span>\n");
PMSFLWrite("</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
...
PMSFLWrite("<div id=\"pmsfl-calculator-retirement-inflation-err1\">Please enter a valid age.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-retirement-inflation-err2\">Please enter a valid peso amount.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-retirement-inflation-err3\">Please enter a valid percentage.</div>\n");
PMSFLWrite("</div>\n");
PMSFLWrite("\n");
...
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("Based on the inflation rate for\n");
PMSFLWrite("<span id=\"pmsfl-calculator-retirement-inflation-retire\"></span>\n");
PMSFLWrite("&#160;years until you retire, you will need\n");
PMSFLWrite("₱<span id=\"pmsfl-calculator-retirement-inflation-first_needs\"></span>\n");
PMSFLWrite("each month the year that you retire, for a total of\n");
PMSFLWrite("₱<span id=\"pmsfl-calculator-retirement-inflation-first_year\"></span>\n");
PMSFLWrite("for the year.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("Using the same inflation rate, you will need\n");
PMSFLWrite("₱<span id=\"pmsfl-calculator-retirement-inflation-last_needs\"></span>\n");
PMSFLWrite("each month the last year of your retirement, for a total of\n");
PMSFLWrite("₱<span id=\"pmsfl-calculator-retirement-inflation-last_year\"></span>\n");
PMSFLWrite("for the year.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("To finance all of the years you plan to be retired including\n");
PMSFLWrite("inflation, you need to have an amount of\n");
PMSFLWrite("₱<span id=\"pmsfl-calculator-retirement-inflation-total\"></span>\n");
PMSFLWrite("saved at the beginning of your retirement.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("</div>\n");
PMSFLWrite("\n");
...
PmsflCalc('retirement-inflation', {
  calculate: function (helper) {
    var c_age = helper.parseFloat('c_age');
    var r_age = helper.parseFloat('r_age');
    var l_age = helper.parseFloat('l_age');
    var needs = helper.parseFloat('needs');
    var irate = helper.parseFloat('irate');

    if (isNaN(c_age)) {return helper.alert(1, 'c_age');}
    if (isNaN(r_age)) {return helper.alert(1, 'r_age');}
    if (isNaN(l_age)) {return helper.alert(1, 'l_age');}
    if (isNaN(needs)) {return helper.alert(2, 'needs');}
    if (isNaN(irate)) {return helper.alert(3, 'irate');}

    var inflation = irate * 0.01 + 1;
    var first_needs = needs * Math.pow(inflation, r_age - c_age);
    var first_year  = first_needs * 12;
    var last_needs  = needs * Math.pow(inflation, l_age - c_age);
    var last_year   = last_needs * 12;

    var start_year = Math.ceil(r_age - c_age);
    var years = Math.ceil(l_age - r_age);
    var total = first_year;

    for (var i=1; i!=years; ++i) {
      total += first_year * Math.pow(inflation, i);
    }

    helper.set('retire', Math.ceil(r_age - c_age), false);
    helper.set('first_needs', first_needs.toFixed(2));
    helper.set('first_year', first_year.toFixed(2));
    helper.set('last_needs', last_needs.toFixed(2));
    helper.set('last_year', last_year.toFixed(2));
