...
PMSFLWrite("<h1>How Much House Can You Afford?</h1>\n");
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("A house is a major investment that will greatly affect your\n");
PMSFLWrite("financial future. Before you start shopping, be sure you know how\n");
PMSFLWrite("much house you can afford.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<form>\n");
PMSFLWrite("<table style=\"width:100%;\">\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-col-1of4\">How much have you saved for a down payment?</td>\n");
...
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>How quickly do you want to pay off your loan?</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("<td>\n");
PMSFLWrite("<select name=\"mortgage\">\n");
PMSFLWrite("<option value=\"60\">5-yr mortgage</option>\n");
PMSFLWrite("<option value=\"120\">10-yr mortgage</option>\n");
PMSFLWrite("<option value=\"180\">15-yr mortgage</option>\n");
PMSFLWrite("<option value=\"240\">20-yr mortgage</option>\n");
PMSFLWrite("<option value=\"300\">25-yr mortgage</option>\n");
PMSFLWrite("<option value=\"360\">30-yr mortgage</option>\n");
PMSFLWrite("</select>\n");
PMSFLWrite("</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>How much can you afford to pay toward a mortgage payment each month?</td>\n");
PMSFLWrite("<td>₱</td>\n");
...
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>What interest rate do you think you can find on a mortgage?</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
...
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>Anticipated closing costs</td>\n");
PMSFLWrite("<td>₱</td>\n");
...
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>Loan origination rate?</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
...
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>Property tax rate</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
...
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>Homeowner\'s insurance rate</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
...
PMSFLWrite("<div id=\"pmsfl-calculator-house-afford-err1\">Please enter a valid peso amount.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-house-afford-err2\">Please enter a valid rate.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-house-afford-err3\">Sorry, you do not have enough cash on hand to cover closing costs.</div>\n");
PMSFLWrite("</div>\n");
PMSFLWrite("\n");
...
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("You could probably afford a ₱<span id=\"pmsfl-calculator-house-afford-price\"></span> home.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("A Note on Private Mortgage Insurance: You will also need to pay\n");
PMSFLWrite("Private Mortgage Insurance (PMI) if the amount you owe on your\n");
PMSFLWrite("home is more than 80% of the value of the home.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("</div>\n");
PMSFLWrite("\n");
