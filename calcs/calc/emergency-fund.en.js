...
PMSFLWrite("\n");
PMSFLWrite("</style>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-emergency-fund\" class=\"pmsfl-calculator\">\n");
PMSFLWrite("<div class=\"calc-outer\">\n");
PMSFLWrite("<div class=\"calc-inner\">\n");
PMSFLWrite("<h1>Emergency Fund</h1>\n");
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("Prepare for the unexpected by saving three to six months of\n");
PMSFLWrite("living expenses. An emergency fund should be easy to access in\n");
PMSFLWrite("the event of unemployment, illness or a major unplanned\n");
PMSFLWrite("expense.  Use this calculator to see how much you need to put\n");
PMSFLWrite("aside for your emergency fund.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<form>\n");
...
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td colspan=\"3\"><h3>Assumptions:</h3></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Current emergency funds available</td>\n");
PMSFLWrite("<td class=\"calc-col-2of3\">₱</td>\n");
PMSFLWrite("<td class=\"calc-col-2of3\"><input type=\"text\" name=\"current\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Number of months you want the emergency funds to last</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"monthslast\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Number of months over which you want to accumulate your emergency fund</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"timeframe\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td colspan=\"3\"><h3>Expenses:</h3></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Total monthly living expenses.  If you plan to itemize (below), leave blank</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"total\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td colspan=\"3\"><h3>or Itemize Monthly:</h3></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Mortgage or rent payment</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_1\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Vacation home (mortgage)</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_2\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Automobile loan(s)</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_3\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Personal loan(s)</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_4\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Charge accounts</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_5\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Federal income tax (per month)</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_6\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">State income tax (per month)</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_6a\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">FICA (social security tax - per month)</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_7\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Real estate taxes - monthly</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_8\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Other taxes</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_9\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Utilities</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_10\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Household repairs and maintenance</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_11\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Food</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_12\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Clothing and laundry</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_13\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Educational expenses</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_14\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Child care</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_15\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Automobile expenses (gas, repairs, etc.)</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_16\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Other transportation expenses</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_17\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Life insurance premiums - monthly</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_18\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Homeowners/renters insurance (monthly)</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_19\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Automobile insurance (monthly)</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_20\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Medical, dental and disability insurance</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_21\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Entertainment and dining</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_22\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Recreation and travel</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_23\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Club dues</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_24\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Hobbies</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_25\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Gifts</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_26\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Major home improvements and furnishings</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_27\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Professional services</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_28\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Contributions</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input type=\"text\" name=\"exp_29\" size=\"10\"/></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
...
PMSFLWrite("<div id=\"pmsfl-calculator-emergency-fund-err1\">Please enter a valid dollar amount.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-emergency-fund-err2\">Please enter a valid number of months.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-emergency-fund-err3\">Please either enter a total monthly expense, or itemize your expenses.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-emergency-fund-msg1\">(Surplus)</div>\n");
PMSFLWrite("</div>\n");
PMSFLWrite("\n");
PMSFLWrite("<div class=\"calc-output\" style=\"display:none\">\n");
PMSFLWrite("<h2>Results</h2>\n");
PMSFLWrite("\n");
PMSFLWrite("<p class=\"calc-need-to-save\" style=\"display:none\">\n");
PMSFLWrite("Based on the assumptions you entered, you can fund your\n");
PMSFLWrite("desired emergency fund by adding a single lump sum of\n");
PMSFLWrite("$<span id=\"pmsfl-calculator-emergency-fund-lump\"></span>\n");
PMSFLWrite("or by saving\n");
PMSFLWrite("$<span id=\"pmsfl-calculator-emergency-fund-save\"></span>\n");
PMSFLWrite("per month for\n");
PMSFLWrite("<span id=\"pmsfl-calculator-emergency-fund-tmonths\"></span>\n");
PMSFLWrite("&#160;months.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<p class=\"calc-surplus\" style=\"display:none\">\n");
PMSFLWrite("You already have enough money saved.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<table style=\"width:100%;\">\n");
PMSFLWrite("<tbody>\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td><h2>Emergency Fund Analysis:</h2></td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>Monthly living expenses</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><span id=\"pmsfl-calculator-emergency-fund-total\"></span></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>\n");
PMSFLWrite("$<span id=\"pmsfl-calculator-emergency-fund-total2\"></span> x\n");
PMSFLWrite("<span id=\"pmsfl-calculator-emergency-fund-lmonths\"></span> &#160;months\n");
PMSFLWrite("</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><span id=\"pmsfl-calculator-emergency-fund-etotal\"></span></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>\n");
PMSFLWrite("$<span id=\"pmsfl-calculator-emergency-fund-etotal2\"></span> -\n");
PMSFLWrite("$<span id=\"pmsfl-calculator-emergency-fund-current\"></span>\n");
PMSFLWrite("(already saved)\n");
PMSFLWrite("</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><span id=\"pmsfl-calculator-emergency-fund-lump2\"></span></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr class=\"calc-montly-breakdown\">\n");
PMSFLWrite("<td>\n");
PMSFLWrite("$<span id=\"pmsfl-calculator-emergency-fund-lump3\"></span> /\n");
PMSFLWrite("<span id=\"pmsfl-calculator-emergency-fund-tmonths2\"></span>\n");
PMSFLWrite("</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><span id=\"pmsfl-calculator-emergency-fund-save2\"></span></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("</tbody>\n");
PMSFLWrite("</table>\n");
PMSFLWrite("</div>\n");
...
PmsflCalc('emergency-fund', {
  calculate: function (helper) {
    var current = helper.parseFloat('current', '0');
    var monthslast = helper.parseFloat('monthslast');
    var timeframe = helper.parseFloat('timeframe');
    var total = helper.parseFloat('total', '0');

    if (isNaN(current))    {return helper.alert(1, 'current');}
    if (isNaN(monthslast)) {return helper.alert(2, 'monthslast');}
    if (isNaN(timeframe))  {return helper.alert(2, 'timeframe');}
    if (isNaN(total))      {return helper.alert(1, 'total');}

    var itemized_total = 0.0;
    var val = 0.0;
    var b = false;

    pmsfljQuery('#' + helper.id + ' input[type=text]').each(function() {
      if (this.name.match(/^exp_/)) {
        val = helper.parseFloat(this.name, '0');
        if (isNaN(val)) {b=true; return helper.alert(1, this.name);}
        itemized_total += val;
      }
    });
    ...
    if (total == 0.0 && itemized_total == 0.0) {
      return helper.alert(3, 'total');
    }

    var actual_total = (total == 0.0 ? itemized_total : total);
    var emerg_total  = actual_total * monthslast;
    var emerg_needed = emerg_total - current;
    var per_month    = emerg_needed / timeframe;

    if (emerg_needed > 0) {
      pmsfljQuery('#' + helper.id + ' .calc-need-to-save').show();
      pmsfljQuery('#' + helper.id + ' .calc-surplus').hide();
      pmsfljQuery('#' + helper.id + ' .calc-montly-breakdown').show();
      helper.set('lump2', emerg_needed.toFixed(2));
    } else {
      pmsfljQuery('#' + helper.id + ' .calc-need-to-save').hide();
      pmsfljQuery('#' + helper.id + ' .calc-surplus').show();
      pmsfljQuery('#' + helper.id + ' .calc-montly-breakdown').hide();
      var lump2 = helper.fmtNumber(Math.abs(emerg_needed).toFixed(2)) + ' ';
      lump2 += helper.msg(1);
      helper.set('lump2', lump2, false);
    }

    helper.set('lump', emerg_needed.toFixed(2));
    helper.set('save', per_month.toFixed(2));
    helper.set('tmonths', Math.ceil(timeframe), false);
    helper.set('total', actual_total.toFixed(2));
    helper.set('total2', actual_total.toFixed(2));
    helper.set('lmonths', Math.ceil(monthslast), false);
    helper.set('etotal', emerg_total.toFixed(2));
    helper.set('etotal2', emerg_total.toFixed(2));
    helper.set('current', current.toFixed(2));
    helper.set('lump3', emerg_needed.toFixed(2));
    helper.set('tmonths2', Math.ceil(timeframe), false);
    helper.set('save2', per_month.toFixed(2));
    helper.show();
  }
});
