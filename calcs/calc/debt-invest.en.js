...
PMSFLWrite("\n");
PMSFLWrite("</style>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-debt-invest\" class=\"pmsfl-calculator\">\n");
PMSFLWrite("<div class=\"calc-outer\">\n");
PMSFLWrite("<div class=\"calc-inner\">\n");
PMSFLWrite("<h1>Should I Pay Down Debt Or Invest My Monthly Surplus?</h1>\n");
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("When you have some surplus cash on hand, it is sometimes\n");
PMSFLWrite("difficult to determine whether you should use it for\n");
PMSFLWrite("investment purposes or pay down your debt. If your after-tax return on\n");
PMSFLWrite("investments is more than your after-tax cost of debt, it is probably better to invest. Just\n");
PMSFLWrite("remember to consider the nature of risk behind the investment\n");
PMSFLWrite("you choose (i.e., you may lose the money you invest, but you\n");
PMSFLWrite("may still have financial obligations to pay back the\n");
PMSFLWrite("liability). Use this calculator to help analyze your current\n");
PMSFLWrite("situation.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<form>\n");
...
PMSFLWrite("<tbody>\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-col-1of4\"><h3>Debt Information</h3></td>\n");
PMSFLWrite("<td colspan=\"3\">&#160;</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Amount of debt</td>\n");
PMSFLWrite("<td class=\"calc-col-2of4\">₱</td>\n");
PMSFLWrite("<td class=\"calc-col-3of4\"><input name=\"debt_amount\" type=\"text\" size=\"10\"/></td>\n");
PMSFLWrite("<td class=\"calc-col-4of4\">&#160;</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Interest rate on debt</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("<td><input name=\"debt_rate\" type=\"text\" size=\"10\"/></td>\n");
PMSFLWrite("<td>%</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Is the interest deductible?</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("<td>\n");
PMSFLWrite("<select name=\"debt_deduct\">\n");
PMSFLWrite("<option value=\"1\">Yes</option>\n");
PMSFLWrite("<option value=\"0\">No</option>\n");
PMSFLWrite("</select>\n");
PMSFLWrite("</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td colspan=\"4\"><h3>Investment Information</h3></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Return on investment (before tax)</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("<td><input name=\"invest_roi\" type=\"text\" size=\"10\"/></td>\n");
PMSFLWrite("<td>%</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Is the interest taxable?</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("<td>\n");
PMSFLWrite("<select name=\"invest_tax\">\n");
PMSFLWrite("<option value=\"1\">Yes</option>\n");
PMSFLWrite("<option value=\"0\">No</option>\n");
PMSFLWrite("</select>\n");
PMSFLWrite("</td>\n");
...
PMSFLWrite("Marginal tax bracket\n");
PMSFLWrite("<a href=\"#\" class=\"calc-help-button\">&#160;&#160;&#160;&#160;&#160;</a>\n");
PMSFLWrite("\n");
PMSFLWrite("<div class=\"calc-help-details\" style=\"display:none\">\n");
PMSFLWrite("<ul class=\"calc-tax-brackets\">\n");
PMSFLWrite("<li>10%  Married &lt; ₱16,750 - Single &lt; ₱8,375</li>\n");
PMSFLWrite("<li>15%  Married ₱16,750-₱68,000 - Single ₱8,375-₱34,000</li>\n");
PMSFLWrite("<li>25%  Married ₱68,000-₱137,300 - Single ₱34,000-₱82,400</li>\n");
PMSFLWrite("<li>28%  Married ₱137,300-₱209,250 - Single ₱82,400-₱171,850</li>\n");
PMSFLWrite("<li>33%  Married ₱209,250-₱373,650 - Single ₱171,850-₱373,650</li>\n");
PMSFLWrite("<li>35%  Married &gt; ₱373,650 - Single &gt; ₱373,650</li>\n");
PMSFLWrite("</ul>\n");
PMSFLWrite("\n");
PMSFLWrite("</div>\n");
PMSFLWrite("</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("<td>\n");
PMSFLWrite("<select name=\"invest_bracket\">\n");
PMSFLWrite("<option value=\"10\">10%</option>\n");
PMSFLWrite("<option value=\"15\">15%</option>\n");
PMSFLWrite("<option value=\"25\">25%</option>\n");
PMSFLWrite("<option value=\"28\">28%</option>\n");
PMSFLWrite("<option value=\"33\">33%</option>\n");
PMSFLWrite("<option value=\"35\">35%</option>\n");
PMSFLWrite("</select>\n");
PMSFLWrite("</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-indent\">Monthly funds available</td>\n");
PMSFLWrite("<td>₱</td>\n");
PMSFLWrite("<td><input name=\"invest_funds\" type=\"text\" size=\"10\"/></td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
...
PMSFLWrite("<div id=\"pmsfl-calculator-debt-invest-err1\">Please enter a valid percentage.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-debt-invest-err2\">Please enter a valid peso amount.</div>\n");
PMSFLWrite("</div>\n");
PMSFLWrite("\n");
...
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("If you use your monthly surplus of\n");
PMSFLWrite("₱<span id=\"pmsfl-calculator-debt-invest-invest_funds\"></span>\n");
PMSFLWrite("to pay down your debt each month, you will save\n");
PMSFLWrite("₱<span id=\"pmsfl-calculator-debt-invest-debt_savings\"></span>\n");
PMSFLWrite("in interest payments (after taxes) after one year.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("If you invested your monthly surplus you will have gained\n");
PMSFLWrite("₱<span id=\"pmsfl-calculator-debt-invest-invest_savings\"></span>\n");
PMSFLWrite("in interest (after taxes) after one year.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("</div>\n");
PMSFLWrite("\n");
...
PmsflCalc('debt-invest', {
  calculate: function (helper) {
    var debt_amount    = helper.parseFloat('debt_amount');
    var debt_rate      = helper.parseFloat('debt_rate');
    var debt_deduct    = helper.parseInt('debt_deduct');
    var invest_roi     = helper.parseFloat('invest_roi');
    var invest_tax     = helper.parseInt('invest_tax');
    var invest_bracket = helper.parseFloat('invest_bracket');
    var invest_funds   = helper.parseFloat('invest_funds');

    if (isNaN(debt_amount))  {return helper.alert(2, 'debt_amount');}
    if (isNaN(debt_rate))    {return helper.alert(1, 'debt_rate');}
    if (isNaN(invest_roi))   {return helper.alert(1, 'invest_roi');}
    if (isNaN(invest_funds)) {return helper.alert(2, 'invest_funds');}

    invest_bracket /= 100.0;
    debt_rate /= 100.0;
    invest_roi /= 100.0;

    var raw_loan = this.payLoanForOneYear(debt_amount, debt_rate, 0.0);
    var debt_raw_interest = raw_loan.interest;
    var debt_principle = raw_loan.principle;

    var helped_loan = this.payLoanForOneYear(debt_amount, debt_rate, invest_funds);
    var debt_helped_interest = helped_loan.interest;
    var debt_savings = debt_raw_interest - debt_helped_interest;
    // if (debt_deduct == 1) {debt_savings -= debt_savings * invest_bracket;}

    helper.set('invest_funds', invest_funds.toFixed(2));
    helper.set('debt_savings', debt_savings.toFixed(2));

    var invest_amount = invest_funds * 12.0;
    var invest_savings = (invest_amount * (1.0 + invest_roi)) - invest_amount;
    if (invest_tax == 1) {invest_savings -= invest_savings * invest_bracket;}

    helper.set('invest_savings', invest_savings.toFixed(2));
    helper.show();
  },
  minimumPayment: function (balance, rate) {
    var outstanding = balance * rate;
    return outstanding + (balance * 0.01);
  },
  payLoanForOneYear: function (balance, rate, extra) {
    var loan = {
      principle: balance,
      interest: 0.0
    };
    ...
    for (var i=0; i!= 12; ++i) {
      var payment = this.minimumPayment(loan.principle, rate);
      var interest = loan.principle * (rate / 12.0);
      payment -= interest;
      payment += extra;
      loan.principle -= payment;
      loan.interest += interest;
      if (loan.principle <= 0) break;
    }
