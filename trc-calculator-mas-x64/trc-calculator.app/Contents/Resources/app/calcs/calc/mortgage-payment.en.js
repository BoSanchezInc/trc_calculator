...
PMSFLWrite("\n");
PMSFLWrite("</style>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-mortgage-payment\" class=\"pmsfl-calculator\">\n");
PMSFLWrite("<div class=\"calc-outer\">\n");
PMSFLWrite("<div class=\"calc-inner\">\n");
PMSFLWrite("<h1>Mortgage Payments</h1>\n");
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("Buying a house is a big step. Calculating the cost of what\n");
PMSFLWrite("your mortgage payment will be is an important part of being a\n");
PMSFLWrite("homeowner.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<form>\n");
...
PMSFLWrite("<tbody>\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-col-1of4\">Mortgage amount</td>\n");
PMSFLWrite("<td class=\"calc-col-2of4\">₱</td>\n");
PMSFLWrite("<td class=\"calc-col-3of4\"><input name=\"amount\" type=\"text\" size=\"10\"/></td>\n");
PMSFLWrite("<td class=\"calc-col-4of4\">&#160;</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>Mortgage term</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("<td>\n");
PMSFLWrite("<select name=\"term\">\n");
PMSFLWrite("<option value=\"15\">15-yr fixed</option>\n");
PMSFLWrite("<option value=\"20\">20-yr fixed</option>\n");
PMSFLWrite("<option value=\"30\">30-yr fixed</option>\n");
PMSFLWrite("</select>\n");
PMSFLWrite("</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>Interest rate (% per year)</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
...
PMSFLWrite("<div id=\"pmsfl-calculator-mortgage-payment-err1\">Please enter a valid peso amount.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-mortgage-payment-err2\">Please enter a valid interest rate.</div>\n");
PMSFLWrite("</div>\n");
PMSFLWrite("\n");
...
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("Monthly mortgage payment:\n");
PMSFLWrite("₱<span id=\"pmsfl-calculator-mortgage-payment-payment\"></span>.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("</div>\n");
PMSFLWrite("\n");
...
PmsflCalc('mortgage-payment', {
  calculate: function (helper) {
    var amount = helper.parseFloat('amount');
    var term   = helper.parseFloat('term', '15');
    var irate  = helper.parseFloat('irate');

    if (isNaN(amount)) {return helper.alert(1, 'amount');}
    if (isNaN(irate))  {return helper.alert(2, 'irate');}

    var payment = helper.mortgagePayment(irate, (term*12), amount);
