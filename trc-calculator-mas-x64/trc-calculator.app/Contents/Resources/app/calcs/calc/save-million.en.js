...
PMSFLWrite("<h1>Save A Million</h1>\n");
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("How long until you\'re a millionaire? If you are saving with\n");
PMSFLWrite("the goal of becoming a millionaire, this calculator can help\n");
PMSFLWrite("you plan your savings and reach your goal!\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<form>\n");
...
PMSFLWrite("<tbody>\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-col-1of4\">Your savings goal (₱1,000,000.00 or other)</td>\n");
...
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>Age when you want to reach your goal</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
...
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>How much money do you currently have saved?</td>\n");
PMSFLWrite("<td>₱</td>\n");
...
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>How much are you depositing on a regular basis?</td>\n");
PMSFLWrite("<td>₱</td>\n");
...
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>How frequently are you contributing to your savings?</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("<td>\n");
PMSFLWrite("<select name=\"freq\">\n");
PMSFLWrite("<option value=\"1\">Yearly</option>\n");
PMSFLWrite("<option value=\"12\">Monthly</option>\n");
PMSFLWrite("<option value=\"26\">Bi-Weekly</option>\n");
PMSFLWrite("<option value=\"52\">Weekly</option>\n");
PMSFLWrite("</select>\n");
PMSFLWrite("</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>What annual interest rate do you expect on your account?</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
...
PMSFLWrite("<div id=\"pmsfl-calculator-save-million-err1\">Please enter a valid peso amount.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-save-million-err2\">Please enter a valid age.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-save-million-err3\">Please enter a valid interest rate.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-save-million-err4\">Sorry, you will never reach your goal.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-save-million-err5\">You already have enough saved up.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-save-million-msg1\">year</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-save-million-msg2\">month</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-save-million-msg3\">week</div>\n");
PMSFLWrite("</div>\n");
PMSFLWrite("\n");
...
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("Saving goal: ₱<span id=\"pmsfl-calculator-save-million-goal\"></span>.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("At your current saving rate it will take you\n");
PMSFLWrite("<span id=\"pmsfl-calculator-save-million-goal_years\"></span>\n");
PMSFLWrite("years to reach your savings goal, including interest earned.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
...
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("To reach your savings goal in\n");
PMSFLWrite("<span id=\"pmsfl-calculator-save-million-want_years\"></span>\n");
PMSFLWrite("years, you will need to save\n");
PMSFLWrite("₱<span id=\"pmsfl-calculator-save-million-goal_save\"></span>\n");
PMSFLWrite("per <span id=\"pmsfl-calculator-save-million-save_freq1\"></span>.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<p class=\"calc-output-million\">\n");
...
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<h2>Saving Tip:</h2>\n");
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("By increasing the amount you save on a regular basis, you\n");
PMSFLWrite("can reduce the time it will take to reach your savings\n");
PMSFLWrite("goal. You\'ll also earn more interest in the long run.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("</div>\n");
PMSFLWrite("\n");
...
PmsflCalc('save-million', {
  calculate: function (helper) {
    ...
    if (isNaN(goal)) {helper.alert(1, 'goal');}
    if (isNaN(age_now)) {helper.alert(2, 'age_now');}
    if (isNaN(age_goal)) {helper.alert(2, 'age_goal');}
    if (isNaN(saved)) {helper.alert(1, 'saved');}
    if (isNaN(deposit)) {helper.alert(1, 'deposit');}
    if (isNaN(irate)) {helper.alert(3, 'irate');}
    ...
    var million_elements = pmsfljQuery('#' + helper.id + ' .calc-output .calc-output-million');
