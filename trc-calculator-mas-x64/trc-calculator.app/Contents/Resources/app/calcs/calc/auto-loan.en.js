...
PMSFLWrite("<h1>How Much Car Can You Afford?</h1>\n");
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("It\'s important to know what price range to look in when shopping for a car.\n");
PMSFLWrite("Binding yourself to a car payment that you can\'t afford can have a very\n");
PMSFLWrite("negative effect on your finances.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<form>\n");
PMSFLWrite("<table style=\"width:100%;\">\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-col-1of4\">How much do you have saved for a down payment?</td>\n");
...
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>What is the trade-in value of your current vehicle?<br /><a href=\"http://www.kbb.com/kbb/UsedCars/default.aspx\" target=\"_blank\">Look up</a></td>\n");
PMSFLWrite("<td>₱</td>\n");
...
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>How quickly do you want to pay off your car?</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("<td>\n");
PMSFLWrite("<select name=\"term\">\n");
PMSFLWrite("<option value=\"60\">60 Mos.</option>\n");
PMSFLWrite("<option value=\"48\">48 Mos.</option>\n");
PMSFLWrite("<option value=\"36\">36 Mos.</option>\n");
PMSFLWrite("<option value=\"24\">24 Mos.</option>\n");
PMSFLWrite("</select>\n");
PMSFLWrite("</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>How much can you afford to pay per month for a car?</td>\n");
PMSFLWrite("<td>₱</td>\n");
...
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>What interest rate do you think you can qualify for on a loan?</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
...
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>What is the sales tax in the county in which you live?</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
...
PMSFLWrite("<div id=\"pmsfl-calculator-auto-loan-err1\">Please enter an amount for your down payment.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-auto-loan-err2\">Please enter a value for the payment amount.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-auto-loan-err3\">Please enter a value for the interest amount.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-auto-loan-err4\">Please enter a value for the tax amount.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-auto-loan-err5\">Please enter a value for the trade-in amount.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-auto-loan-err6\">Please enter a value for the rebates amount.</div>\n");
PMSFLWrite("</div>\n");
PMSFLWrite("\n");
...
PMSFLWrite("Paying ₱<span id=\"pmsfl-calculator-auto-loan-payment\"></span> a month for <span id=\"pmsfl-calculator-auto-loan-term\"></span> months,\n");
PMSFLWrite("you should be able to afford a car that costs ₱ <span id=\"pmsfl-calculator-auto-loan-cost_car\"></span>.\n");
PMSFLWrite("</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>Total cost of the car</td>\n");
PMSFLWrite("<td>₱<span id=\"pmsfl-calculator-auto-loan-cost_car2\"></span></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>Down payment + trade-in + rebates</td>\n");
PMSFLWrite("<td>₱<span id=\"pmsfl-calculator-auto-loan-downpay\"></span></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>Tax</td>\n");
PMSFLWrite("<td>₱<span id=\"pmsfl-calculator-auto-loan-sales_tax\"></span></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>Total loan amount</td>\n");
...
PmsflCalc('auto-loan', function (helper) {
  var downpay  = helper.parseFloat('downpay', '0.0');
  var tradein  = helper.parseFloat('tradein', '0.0');
  var rebates  = helper.parseFloat('rebates', '0.0');
